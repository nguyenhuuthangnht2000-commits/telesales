...
abstract class TelesalesDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_3_4 = object : Migration(3, 4) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE call_records ADD COLUMN latitude REAL")
                db.execSQL("ALTER TABLE call_records ADD COLUMN longitude REAL")
                db.execSQL("ALTER TABLE failed_calls ADD COLUMN latitude REAL")
                db.execSQL("ALTER TABLE failed_calls ADD COLUMN longitude REAL")
            }
        }
