...
class CallMetadataMapperTest {
    ...
    fun normalizePhone_validFormats() {
        val call1 = CallMetadataMapper.create(1, 1L, null, CallType.INCOMING, "+84912345678", "0912345678", 0, null)
        assertThat(call1.phoneNumberFrom).isEqualTo("0912345678")

        val call2 = CallMetadataMapper.create(1, 1L, null, CallType.INCOMING, "84912345678", "0912345678", 0, null)
        assertThat(call2.phoneNumberFrom).isEqualTo("0912345678")

        val call3 = CallMetadataMapper.create(1, 1L, null, CallType.INCOMING, "0912345678", "0912345678", 0, null)
    ...
    @Test
    fun incomingCall() {
        val call = CallMetadataMapper.create(1, 1L, null, CallType.INCOMING, "0912345678", "0987654321", 0, null)
    ...
    @Test
    fun outgoingCall() {
        val call = CallMetadataMapper.create(1, 1L, null, CallType.OUTGOING, "0912345678", "0987654321", 0, null)
    ...
    fun metadataFields_areSet() {
        val call = CallMetadataMapper.create(1, 1000L, "uri", CallType.OUTGOING, "0912345678", "0987654321", 10, null)
